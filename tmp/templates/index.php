    ...
    <div class="banner_inner d-flex align-items-center">
        ...
        <div class="container">
            <div class="banner_content text-center">
                ...
                <p>we are very commited to bringing you relevant information on scholarships to aid students academically and financially</p>
...
<section class="courses_area p_120">
    <div class="container">
        <div class="main_title">
            <h2>Latest Available scholarships</h2>
            <p>we are very commited to bringing you relevant information on scholarships to aid students academically and financially.</p>
        </div>
        ...
        <div class="row latest_blog_inner">
            <div class="col-lg-3 col-md-6">
                <div class="l_blog_item">
                    ...
                    <a href="single-blog.php"><h4>Addiction When Gambling Becomes A Problem</h4></a>
                    <p>we are very commited to bringing you relevant information on scholarships to aid students academically and financially</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
